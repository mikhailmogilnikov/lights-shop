...
echo "Создаем схему product_schema..."
PGPASSWORD=postgres psql -h postgres -U postgres -d lights-shop -c "CREATE SCHEMA IF NOT EXISTS product_schema;" || echo "Схема уже существует или ошибка создания"
